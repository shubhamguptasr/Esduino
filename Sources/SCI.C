...
void SCI_Init(unsigned short baudRate){
  ...
  switch(baudRate){
    case 2400:  SCI0BDL=417; break;
    case 4800:  SCI0BDL=208;  break;
    case 9600:  SCI0BDL=104;  break;
    case 19200: SCI0BDL=52;  break;
    case 38400: SCI0BDL=26;  break;
    default:    SCI0BDL = 104 ;  // 9600 
  }
  SCI0CR1 = 0;
/* bit value meaning
